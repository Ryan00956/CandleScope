...
class PyneSecurityPolicy:
    ...
    def from_config(cls, requested_mode: str | None = None) -> "PyneSecurityPolicy":
        mode = normalize_security_mode(requested_mode or config.PYNE_SECURITY_MODE)
        return cls(
            mode=mode,
    ...
    def to_public_dict(self) -> dict[str, Any]:
        return {
            ...
            "executorMode": config.PYNE_EXECUTOR_MODE,
            "cacheMaxItems": config.PYNE_CACHE_MAX_ITEMS,
        }
