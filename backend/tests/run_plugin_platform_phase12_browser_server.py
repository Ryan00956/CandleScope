"""Launch the Phase 12 browser fixture with repository-local sources."""
...
def main() -> int:
    ...
    parser.add_argument("--origin", default="http://127.0.0.1:18132")
    ...
    uvicorn.run(
        "tests.plugin_platform_phase12_browser_server:app",
        host=args.host,
        port=args.port,
    )
    return 0
