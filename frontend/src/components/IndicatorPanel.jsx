...
`,
  ...
  return (
    <div className="indicator-panel-overlay" onClick={onClose}>
      <div className="indicator-panel" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
      ...
      {/* ── Editor: rendered as a portal so it appears centered on screen ── */}
      {tab === "editor" && editingIndicator && createPortal(
        <div className="indicator-editor-overlay" onClick={handleEditorBack}>
