...
function sortCustomRecords(records) {
...
function buildToolbarCustomRecords(records, activeInterval) {
...
function createStatusForValue(value, nativeValueSet, customValueSet) {
...
export default function IntervalSelector({
  ...
  const createOrSelectInterval = useCallback((value) => {
    const normalized = normalizeIntervalValue(value);
  ...
  const renderIntervalButton = (item, extraClass = "") => (
    <button
      key={item.value}
  ...
  const renderIntervalRow = (item, index) => {
