...
/** @typedef {{ label: string, detail: string, documentation: string, insertText: string, kind: string }} PyneItem */
...
const GLOBAL_VARIABLES = [
  { label: "open", detail: "np.ndarray", documentation: "开盘价数组 (Open prices)", insertText: "open", kind: "Variable" },
  { label: "high", detail: "np.ndarray", documentation: "最高价数组 (High prices)", insertText: "high", kind: "Variable" },
  { label: "low", detail: "np.ndarray", documentation: "最低价数组 (Low prices)", insertText: "low", kind: "Variable" },
  { label: "close", detail: "np.ndarray", documentation: "收盘价数组 (Close prices)", insertText: "close", kind: "Variable" },
  { label: "volume", detail: "np.ndarray", documentation: "成交量数组 (Volume)", insertText: "volume", kind: "Variable" },
  { label: "time", detail: "list[int]", documentation: "时间戳列表 (Timestamps)", insertText: "time", kind: "Variable" },
  { label: "bar_count", detail: "int", documentation: "K线数量 (Number of bars)", insertText: "bar_count", kind: "Variable" },
  { label: "hl2", detail: "np.ndarray", documentation: "(high + low) / 2", insertText: "hl2", kind: "Variable" },
  { label: "hlc3", detail: "np.ndarray", documentation: "(high + low + close) / 3", insertText: "hlc3", kind: "Variable" },
  { label: "ohlc4", detail: "np.ndarray", documentation: "(open + high + low + close) / 4", insertText: "ohlc4", kind: "Variable" },
  { label: "hlcc4", detail: "np.ndarray", documentation: "(high + low + close × 2) / 4", insertText: "hlcc4", kind: "Variable" },
  { label: "np", detail: "module", documentation: "NumPy 库 (import numpy as np)", insertText: "np", kind: "Module" },
  { label: "numpy", detail: "module", documentation: "NumPy 库", insertText: "numpy", kind: "Module" },
  { label: "params", detail: "dict", documentation: "用户参数字典 (Legacy compatibility)", insertText: "params", kind: "Variable" },
];
...
const GLOBAL_FUNCTIONS = [
  ...
  },
  {
    ...
    insertText: 'fill(${1:plot1}, ${2:plot2}, color="${3:rgba(59,130,246,0.1)}")',
    kind: "Function",
  },
  {
    label: "bar",
  ...
  },
  {
    ...
    insertText: 'marker(${1:condition}, shape="${2:triangle_up}", color=${3:color.green}, text="${4:Signal}")',
    kind: "Function",
  },
  {
    label: "bgcolor",
  ...
  // ── Utility functions (global) ──
  {
    ...
    documentation: "金叉检测 — 当 a 从下方穿越 b 时为 True\n\n```python\ncrossover(fast_ma, slow_ma)\n```",
  ...
  },
  {
    label: "crossunder",
    detail: "(a, b) → np.ndarray[bool]",
    documentation: "死叉检测 — 当 a 从上方穿越 b 时为 True\n\n```python\ncrossunder(fast_ma, slow_ma)\n```",
  ...
  },
  {
    ...
    documentation: "将数组平移 n 个位置 (正数向右/过去)\n\n```python\nyesterday_close = shift(close, 1)\n```",
...
const TA_FUNCTIONS = [
  ...
  },
  {
    label: "wma",
    detail: "(src, period) → np.ndarray",
    documentation: "加权移动平均线 (Weighted Moving Average)\n\n权重: [1, 2, ..., period]\n\n```python\nta.wma(close, 20)\n```",
  ...
  },
  {
    label: "rma",
    detail: "(src, period) → np.ndarray",
    documentation: "Wilder 平滑移动平均 (Running Moving Average)\n\n用于 RSI 和 ATR 内部计算。α = 1/period\n\n```python\nta.rma(close, 14)\n```",
  ...
  },
  {
    ...
    documentation: "成交量加权移动平均 (Volume-Weighted MA)\n\n```python\nta.vwma(close, 20)\n```",
  ...
  },
  {
    ...
    documentation: "商品通道指数 (Commodity Channel Index)\n\n```python\ncci = ta.cci(period=20)\nplot(cci, \"CCI\")\n```",
  ...
  },
  {
    ...
    documentation: "资金流量指数 (Money Flow Index)\n\n```python\nplot(ta.mfi(14), \"MFI\", pane=\"separate\")\n```",
    insertText: "mfi(${1:14})",
    kind: "Method",
  },
  // ── Trend ──
  ...
  },
  {
    label: "atr",
    detail: "(period=14) → np.ndarray",
    documentation: "平均真实波幅 (Average True Range)\n\nATR = Wilder 平滑 of TR\n\n```python\nplot(ta.atr(14), \"ATR(14)\", pane=\"separate\")\n```",
    insertText: "atr(${1:14})",
    kind: "Method",
  },
  {
  ...
  },
  {
    label: "stdev",
    detail: "(src, period) → np.ndarray",
    documentation: "滚动标准差 (Standard Deviation)\n\n```python\nta.stdev(close, 20)\n```",
  ...
  },
  {
    ...
    documentation: "肯特纳通道 (Keltner Channel)\n\n```python\nupper, mid, lower = ta.keltner(20, 1.5)\n```",
  ...
  },
  {
    ...
    documentation: "唐奇安通道 (Donchian Channel)\n\n```python\nupper, mid, lower = ta.donchian(20)\n```",
  ...
  // ── Volume ──
  {
    ...
    documentation: "能量潮指标 (On-Balance Volume)\n\n```python\nplot(ta.obv(), \"OBV\", pane=\"separate\")\n```",
    insertText: "obv()",
    kind: "Method",
  },
  {
...
const INPUT_FUNCTIONS = [
  ...
  },
  {
    ...
    documentation: "声明字符串参数 (可选提供选项列表)\n\n```python\nma_type = input.string(\"EMA\", \"MA类型\", options=[\"SMA\", \"EMA\", \"WMA\"])\n```",
    insertText: 'string("${1:SMA}", "${2:Type}", options=[${3:"SMA", "EMA", "WMA"}])',
    kind: "Method",
  },
  {
    label: "source",
    detail: "(default, title) → np.ndarray",
    documentation: "声明数据源参数 (传入 close/open/high/low/hl2 等)\n\n```python\nsrc = input.source(close, \"数据源\")\n```",
 ...
 */
const COLOR_MEMBERS = [
  { label: "red", detail: '"#ef4444"', documentation: "红色", insertText: "red", kind: "Property" },
  { label: "green", detail: '"#22c55e"', documentation: "绿色", insertText: "green", kind: "Property" },
  { label: "blue", detail: '"#3b82f6"', documentation: "蓝色", insertText: "blue", kind: "Property" },
  { label: "orange", detail: '"#f59e0b"', documentation: "橙色", insertText: "orange", kind: "Property" },
  { label: "purple", detail: '"#a855f7"', documentation: "紫色", insertText: "purple", kind: "Property" },
  { label: "yellow", detail: '"#eab308"', documentation: "黄色", insertText: "yellow", kind: "Property" },
  { label: "cyan", detail: '"#06b6d4"', documentation: "青色", insertText: "cyan", kind: "Property" },
  { label: "white", detail: '"#ffffff"', documentation: "白色", insertText: "white", kind: "Property" },
  { label: "black", detail: '"#000000"', documentation: "黑色", insertText: "black", kind: "Property" },
  { label: "gray", detail: '"#787b86"', documentation: "灰色", insertText: "gray", kind: "Property" },
  { label: "lime", detail: '"#00e676"', documentation: "亮绿", insertText: "lime", kind: "Property" },
  { label: "aqua", detail: '"#00bcd4"', documentation: "水色", insertText: "aqua", kind: "Property" },
  { label: "teal", detail: '"#009688"', documentation: "青绿", insertText: "teal", kind: "Property" },
  { label: "maroon", detail: '"#880e4f"', documentation: "栗色", insertText: "maroon", kind: "Property" },
  { label: "fuchsia", detail: '"#e040fb"', documentation: "品红", insertText: "fuchsia", kind: "Property" },
  { label: "silver", detail: '"#b2b5be"', documentation: "银色", insertText: "silver", kind: "Property" },
  { label: "navy", detail: '"#1a237e"', documentation: "藏蓝", insertText: "navy", kind: "Property" },
  { label: "olive", detail: '"#808000"', documentation: "橄榄", insertText: "olive", kind: "Property" },
  {
    label: "new",
    detail: "(hex_color, transparency) → str",
    documentation: "创建带透明度的颜色\n\ntransparency: 0=不透明, 100=完全透明\n\n```python\ncolor.new(\"#ef4444\", 80)  # 80%透明的红色\ncolor.new(color.blue, 50) # 50%透明的蓝色\n```",
 ...
 */
const MATH_MEMBERS = [
  { label: "abs", detail: "(x) → array|float", documentation: "绝对值", insertText: "abs(${1:x})", kind: "Method" },
  { label: "log", detail: "(x) → array|float", documentation: "自然对数", insertText: "log(${1:x})", kind: "Method" },
  { label: "log10", detail: "(x) → array|float", documentation: "常用对数", insertText: "log10(${1:x})", kind: "Method" },
  { label: "sqrt", detail: "(x) → array|float", documentation: "平方根", insertText: "sqrt(${1:x})", kind: "Method" },
  { label: "exp", detail: "(x) → array|float", documentation: "指数函数 e^x", insertText: "exp(${1:x})", kind: "Method" },
  { label: "pow", detail: "(base, exp) → array|float", documentation: "幂运算", insertText: "pow(${1:base}, ${2:exp})", kind: "Method" },
  { label: "ceil", detail: "(x) → array|float", documentation: "向上取整", insertText: "ceil(${1:x})", kind: "Method" },
  { label: "floor", detail: "(x) → array|float", documentation: "向下取整", insertText: "floor(${1:x})", kind: "Method" },
  { label: "round", detail: "(x, precision=0) → array|float", documentation: "四舍五入", insertText: "round(${1:x})", kind: "Method" },
  { label: "max", detail: "(a, b) → array|float", documentation: "最大值（支持数组）", insertText: "max(${1:a}, ${2:b})", kind: "Method" },
  { label: "min", detail: "(a, b) → array|float", documentation: "最小值（支持数组）", insertText: "min(${1:a}, ${2:b})", kind: "Method" },
  { label: "sign", detail: "(x) → array|float", documentation: "符号函数 (-1, 0, 1)", insertText: "sign(${1:x})", kind: "Method" },
  { label: "avg", detail: "(*args) → array|float", documentation: "多个值的平均\n\n```python\nmath.avg(high, low, close)\n```", insertText: "avg(${1:a}, ${2:b})", kind: "Method" },
  { label: "sum", detail: "(src, period) → np.ndarray", documentation: "滚动求和", insertText: "sum(${1:src}, ${2:20})", kind: "Method" },
  { label: "sin", detail: "(x) → array|float", documentation: "正弦", insertText: "sin(${1:x})", kind: "Method" },
  { label: "cos", detail: "(x) → array|float", documentation: "余弦", insertText: "cos(${1:x})", kind: "Method" },
  { label: "tan", detail: "(x) → array|float", documentation: "正切", insertText: "tan(${1:x})", kind: "Method" },
  { label: "pi", detail: "3.14159...", documentation: "圆周率 π", insertText: "pi", kind: "Property" },
  { label: "e", detail: "2.71828...", documentation: "自然常数 e", insertText: "e", kind: "Property" },
];
...
function buildHoverMap() {
  ...
  for (const item of [...GLOBAL_VARIABLES, ...GLOBAL_FUNCTIONS]) {
    map.set(item.label, { detail: item.detail, documentation: item.documentation, prefix: "" });
  }
  // ta.*
  for (const item of TA_FUNCTIONS) {
    map.set(`ta.${item.label}`, { detail: item.detail, documentation: item.documentation, prefix: "ta." });
  }
  // input.*
  for (const item of INPUT_FUNCTIONS) {
    map.set(`input.${item.label}`, { detail: item.detail, documentation: item.documentation, prefix: "input." });
  }
  // color.*
  for (const item of COLOR_MEMBERS) {
    map.set(`color.${item.label}`, { detail: item.detail, documentation: item.documentation, prefix: "color." });
  }
  // math.*
  for (const item of MATH_MEMBERS) {
    map.set(`math.${item.label}`, { detail: item.detail, documentation: item.documentation, prefix: "math." });
  }
  return map;
}
 ...
 */
export function registerPyneLanguageSupport(monaco) {
  const disposables = [];
      ...
      provideCompletionItems(model, position) {
        ...
        for (const ns of ["ta", "input", "color", "math"]) {
          suggestions.push({
            ...
            documentation: { value: `输入 \`${ns}.\` 触发自动补全`, isTrusted: true },
            insertText: `${ns}.`,
            range,
            sortText: `0_${ns}`,
