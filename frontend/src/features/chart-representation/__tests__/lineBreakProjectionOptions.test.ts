...
test("Line Break options normalize the configured lookback", () => {
  ...
  assert.deepEqual(
    resolveLineBreakProjectorOptions([{ time: 1, open: 1.23, high: 1.24, low: 1.2, close: 1.21 }]),
...
test("Line Break tick inference depends only on source closes", () => {
  const ordinaryRows = [
    { time: 1, open: 1.2, high: 1.3, low: 1.1, close: 1.2 },
    { time: 2, open: 1.2, high: 1.4, low: 1.1, close: 1.3 },
  ];
  const preciseWickRows = [
    { time: 1, open: 1.20000001, high: 1.34567891, low: 1.10000001, close: 1.2 },
    { time: 2, open: 1.20000001, high: 1.45678912, low: 1.10000001, close: 1.3 },
  ];
