...
This feature owns the Binance futures order-book subscription lifecycle and UI.
...
The current backend scope is intentionally explicit: Binance U-margined futures only, with no historical replay.
