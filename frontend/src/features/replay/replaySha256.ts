...
/** Deterministic SHA-256 for non-secure HTTP browser contexts without Web Crypto. */
export function replaySha256Hex(bytes: Uint8Array): string {
...
export function replaySha256Utf8(value: string): string {
  return replaySha256Hex(new TextEncoder().encode(value));
}
