...
export const ORDINARY_RESEARCH_TERMS = {
  currentChart: { en: "Current chart", zh: "当前图表", ja: "現在のチャート" },
  importedLibrary: { en: "Local library", zh: "本地资料库", ja: "ローカルライブラリ" },
  completedResult: { en: "Completed result", zh: "完成结果", ja: "完了した結果" },
  dataVersion: { en: "Data version", zh: "数据版本", ja: "データ版" },
  frozenReproducible: { en: "Data is frozen and reproducible", zh: "数据已冻结，可复现", ja: "データは凍結済みで再現できます" },
  dataGap: { en: "Data has gaps", zh: "数据有缺口", ja: "データに欠落があります" },
  barApprox: { en: "Bar estimate", zh: "基于 K 线估算", ja: "ローソク足からの推定" },
} as const;
